...
var Paginator = React.createClass({displayName: "Paginator",
    ...
    render: function() {
        ...
        if (this.props.splitTemplate) {
            html = (
                React.createElement("div", null, 
                  ...
                  this.getPageRange().map(this.renderPage, this)
                    ...
                    React.createElement("ul", {className: "pager-nav"}, 
                        React.createElement("li", {className: prevClassName, onClick: this.onClick.bind(this, page - 1)}, 
                            React.createElement("a", {href: "#", onClick: this.preventDefault}, 
                            this.props.prevText
                            )
                        ), 
                        React.createElement("li", {className: nextClassName, onClick: this.onClick.bind(this, page + 1)}, 
                            React.createElement("a", {href: "#", onClick: this.preventDefault}, 
                            this.props.nextText
                            )
                        )
            ...
            html = (
                React.createElement("div", null, 
                    React.createElement("ul", {className: "pager-full"}, 
                        React.createElement("li", {className: prevClassName, onClick: this.onClick.bind(this, page - 1)}, 
                            React.createElement("a", {href: "#", onClick: this.preventDefault}, 
                            this.props.prevText
                            )
        ...
        return (
            React.createElement("div", {className: "pager-container"}, 
                html
            )
        );
    },
    ...
    renderPage: function(n, i) {
        ...
        return (
            React.createElement("li", {key: i, className: cls, onClick: this.onClick.bind(this, n)}, 
                React.createElement("a", {href: "#", onClick: this.preventDefault}, n)
            )
        );
    }
});
...
var Audio = React.createClass({displayName: "Audio",
    ...
    render: function() {
        return (
            React.createElement("audio", {id: "audio", src: this.props.src})
        );
    }
});
        ...
        return (
            React.createElement("div", {className: "row"}, 
                React.createElement("div", {className: "columns large-12"}, 
                    React.createElement("h1", null, React.createElement(Link, {to: "/"}, "Header"))
                )
            )
        );
    }
...
var svgIcons = {
    "left": '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 255.12 255.12" enable-background="new 0 0 255.12 255.12" xml:space="preserve"><g><path fill="#BFBFBF" d="M127.423,1.75c-69.714,0-126.43,56.716-126.43,126.433s56.716,126.433,126.43,126.433S253.856,197.9,253.856,128.183S197.137,1.75,127.423,1.75z M127.423,244.744c-64.27,0-116.558-52.288-116.558-116.561S63.153,11.621,127.423,11.621c64.274,0,116.561,52.288,116.561,116.561S191.697,244.744,127.423,244.744z"/><path fill="#BFBFBF" d="M191.896,122.701H78.05l55.401-55.398c1.928-1.928,1.928-5.051,0-6.979c-1.928-1.928-5.051-1.928-6.979,0L62.78,124.012c-1.928,1.928-1.928,5.051,0,6.979c0.087,0.087,0.188,0.15,0.28,0.229c0.011,0.011,0.017,0.024,0.028,0.034l63.692,63.695c0.964,0.964,2.227,1.446,3.49,1.446c1.263,0,2.526-0.482,3.49-1.446c1.928-1.928,1.928-5.051,0-6.979l-55.396-55.398h113.532c2.725,0,4.936-2.211,4.936-4.936C196.832,124.911,194.621,122.701,191.896,122.701z"/></g></svg>',
    "menu": '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve"><g id="Icons" style="opacity:0.75;"><path id="menu" d="M6,15h12c0.553,0,1,0.447,1,1v1c0,0.553-0.447,1-1,1H6c-0.553,0-1-0.447-1-1v-1C5,15.447,5.447,15,6,15z M5,11v1c0,0.553,0.447,1,1,1h12c0.553,0,1-0.447,1-1v-1c0-0.553-0.447-1-1-1H6C5.447,10,5,10.447,5,11z M5,6v1c0,0.553,0.447,1,1,1h12c0.553,0,1-0.447,1-1V6c0-0.553-0.447-1-1-1H6C5.447,5,5,5.447,5,6z"/></g><g id="Guides" style="display:none;"></g></svg>',
    "home": '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="480px" height="480px" viewBox="0 0 480 480" style="enable-background:new 0 0 480 480;" xml:space="preserve"><path style="fill-rule:evenodd;clip-rule:evenodd;" d="M233.333,160c-4.703,4.703-69.124,65.807-106.666,101.395v125.272h80v-100h66.666v100h80V261.189C314.309,224.083,246.667,160,246.667,160S240,153.333,233.333,160z M353.333,120c0-7.363-5.97-13.333-13.333-13.333h-26.667c-7.363,0-13.333,5.97-13.333,13.333v11.562c16.895,16.159,35.998,34.396,53.333,50.932V120z M406.667,246.667c0,0-140-133.334-153.334-146.667c-13.333-13.333-26.666,0-26.666,0S80,240,73.333,246.667c-6.666,6.666,0,13.333,0,13.333s6.667,6.667,13.334,13.333c6.666,6.667,13.333,0,13.333,0s126.667-120,133.333-126.666c6.667-6.667,13.334,0,13.334,0s126.666,120,133.333,126.666c6.667,6.667,13.333,0,13.333,0s0,0,13.334-13.333C413.333,253.333,406.667,246.667,406.667,246.667z"/></svg>',
...
var svg = function(iconName) {
    var html = {__html: svgIcons[iconName]};
    return (
        React.createElement("span", {dangerouslySetInnerHTML: html})
    );
};
var TaskTitle = React.createClass({displayName: "TaskTitle",
    getDefaultProps: function() {
        return {
            title: 'Unknown'
        };
    ...
    render: function() {
        ...
        var backlink = false ? (
            React.createElement(Link, {to: "Tasks", className: "task-back-link"}, svg('left'), " ", React.createElement("span", {className: "task-back-link-text"}, "К списку задач"))
        ) : null;
        return (
            React.createElement("div", {className: "task-title-container"}, 
                backlink, 
...
var NotFoundPage = React.createClass({displayName: "NotFoundPage",
  render: function() {
    return (
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {className: "columns large-10"}, 
            React.createElement("div", {className: "not-found-page"}, 
                React.createElement("h1", null, "Страница не найдена"), 
                React.createElement("p", null, React.createElement(Link, {to: "/"}, "Перейти на главную"))
            )
        )
      )
    );
...
var HelloHandler = React.createClass({displayName: "HelloHandler",
    render: function() {
...
var IndexHandler = React.createClass({displayName: "IndexHandler",
    render: function() {
        return (
            React.createElement("div", {className: "row"}, 
                React.createElement("div", {className: "columns large-12"}, 
                    ...
                    React.createElement("ul", null, 
                        React.createElement("li", null, 
                            React.createElement(Link, {to: "Hello", params: {name: "john"}}, "Hello link")
                        ), 
                        React.createElement("li", null, 
                            React.createElement(ModalLink, {name: "Hello modal"}, 
                                "Hello modal"
                            )
                        )
                    )
...
var ReactLayeredComponentMixin = {
    ...
    componentDidMount: function() {
        ...
        // in mount order).
        this._target = document.createElement('div');
        if (typeof this.prepareNode instanceof Function) {
            this.prepareNode();
        }
        document.body.appendChild(this._target);
        this._renderLayer();
...
var Modal = React.createClass({displayName: "Modal",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", React.__spread({},  this.props, {className: containerCls, onClick: this.handleBackdropClick}), 
                React.createElement("div", {className: cls, onClick: this.killClick}, 
                    React.createElement("a", {href: "javascript:;", role: "button", className: "modal-close", onClick: this.handleBackdropClick}), 
                    this.props.children
                )
            )
        );
...
var ModalLink = React.createClass({displayName: "ModalLink",
    ...
    renderLayer: function() {
        ...
        return (React.createElement(Modal, {className: this.props.modalClassName, onRequestClose: this.handleClick}, modal));
    },
    render: function() {
        return (
            React.createElement("a", {href: "javascript:;", role: "button", className: this.props.className || '', onClick: this.handleClick}, this.props.name)
        );
    }
});
...
var routes = (
    React.createElement(Route, {handler: App, path: "/"}, 
        React.createElement(DefaultRoute, {handler: IndexHandler}), 
        React.createElement(Route, {name: "Index", path: "/", handler: IndexHandler}), 
        React.createElement(Route, {name: "Hello", path: "/hello/:name", handler: HelloHandler}), 
        React.createElement(NotFoundRoute, {name: "notfound", handler: NotFoundPage})
    )
);
